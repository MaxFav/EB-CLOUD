...
class print_commission_summary_template(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('aspl_sales_commission_ee.print_commission_template')
        # print("-----------",self.env['wizard.commission.summary'].search([('id', 'in', list(data["ids"]))]))
